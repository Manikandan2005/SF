...
con_string = "mongodb+srv://Manikandan:licet123@cluster0.amub5cf.mongodb.net/?retryWrites=true&w=majority"

client = pymongo.MongoClient(con_string)

db = client.get_database('users')

user_collection = pymongo.collection.Collection(db, 'Authen') #(<database_name>,"<collection_name>")
